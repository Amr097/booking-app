...
.results__card--review {
  @apply ml-4 leading-5 tracking-wide;
  color: #4f4f4f;
}
.location {
  @apply flex items-center gap-2 text-xl leading-5 tracking-wide;
  color: #333;
}
.overview {
  @apply p-8;
...
.overview__item {
  @apply flex items-center gap-x-4 text-xl leading-9 tracking-wide mb-6;
  color: #4f4f4f;
}
